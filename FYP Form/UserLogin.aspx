...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<br />
	Username<asp:TextBox runat="server" ID="UserName" CssClass="form-control" />
	<br />
	Password<asp:TextBox runat="server" ID="Password" TextMode="Password" CssClass="form-control" />
	<br />
