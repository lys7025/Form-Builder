<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FYP_Form.Edit" %>
...
<script type="text/javascript">
	...
	function addRadio() {
		...
		alert("Add Successfully");
		countRBchild++;
		document.getElementById('<%=hfRadioChild.ClientID%>').value = countRBchild;
	}
	...
	function addCheck() {
		...
		countCheckchild++;
		document.getElementById('<%=hfCheckChild.ClientID%>').value = countCheckchild;
	}
	...
	$(function () {
		...
		$("#container").droppable({
			drop: function (event, ui) {
				...
				if (ui.draggable.attr('id') == 'li_txtfield') {//get how many textfield at here
					if (document.getElementById('<%=hfText.ClientID%>').value != "") {
						countTxt = document.getElementById('<%=hfText.ClientID%>').value;
					}
					countTxt++;
				...
				if (ui.draggable.attr('id') == 'li_ddl') {
					if (document.getElementById('<%=hfDrop.ClientID%>').value != "") {
						countDdl = document.getElementById('<%=hfDrop.ClientID%>').value;
					}
					countDdl++;
				...
				if (ui.draggable.attr('id') == 'li_rb') {
					if (document.getElementById('<%=hfRadio.ClientID%>').value != "") {
						countRb = document.getElementById('<%=hfRadio.ClientID%>').value;
					}
					countRb++;
				...
				if (ui.draggable.attr('id') == 'li_textarea') {
					if (document.getElementById('<%=hfTextarea.ClientID%>').value != "") {
						counttextArea = document.getElementById('<%=hfTextarea.ClientID%>').value;
					}
					counttextArea++;
				...
				if (ui.draggable.attr('id') == 'li_checkbox') {
					if (document.getElementById('<%=hfCheck.ClientID%>').value != "") {
						countcheck = document.getElementById('<%=hfCheck.ClientID%>').value;
					}
					countcheck++;
				...
				if (ui.draggable.attr('id') == 'li_header') {
					if (document.getElementById('<%=hfHeader.ClientID%>').value != "") {
						countheader = document.getElementById('<%=hfHeader.ClientID%>').value;
					}
					countheader++;
				...
				if (ui.draggable.attr('id') == 'li_paragraph') {
					if (document.getElementById('<%=hfParagraph.ClientID%>').value != "") {
						countparagraph = document.getElementById('<%=hfParagraph.ClientID%>').value;
					}
					countparagraph++;
				...
				if (ui.draggable.attr('id') == 'li_number') {
					if (document.getElementById('<%=hfNumber.ClientID%>').value != "") {
						countnumber = document.getElementById('<%=hfNumber.ClientID%>').value;
					}
					countnumber++;
				...
				if (ui.draggable.attr('id') == 'li_date') {
					if (document.getElementById('<%=hfDate.ClientID%>').value != "") {
						countdate = document.getElementById('<%=hfDate.ClientID%>').value;
					}
					countdate++;
				...
				if (ui.draggable.attr('id') == 'li_file') {
					if (document.getElementById('<%=hfFile.ClientID%>').value != "") {
						countfile = document.getElementById('<%=hfFile.ClientID%>').value;
					}
					countfile++;
				...
				if (ui.draggable.attr('id') == 'li_label') {
					if (document.getElementById('<%=hfLabel.ClientID%>').value != "") {
						countlabel = document.getElementById('<%=hfLabel.ClientID%>').value;
					}
					countlabel++;
				...
				if (ui.draggable.attr('id') == 'li_image') {
					if (document.getElementById('<%=hfImage.ClientID%>').value != "") {
						countImage = document.getElementById('<%=hfImage.ClientID%>').value;
					}
					countImage++;
		...
		$('#<%=btnInsert.ClientID%>').click(function () {
			...
			if (document.getElementById('<%=hfFile.ClientID%>').value > 0) {
				var arrLeft = [];
				var arrTop = [];
				for (var j = 1; j <= document.getElementById('<%=hfFile.ClientID%>').value; j++) {
			...
			drop: function (event, ui) {
				...
				if (countfile > 0) {
					...
					<%--for (i = 1; i <= countfile; i++) {
						if (ui.draggable.attr('id') == 'li_file' + i) {
							--countfile;
							document.getElementById('<%=hfFile.ClientID%>').value = countfile;
						}
					}--%>
		...
		function cloneUniqueId(event) {
			//return textbox               
			return '<div id="li_txtfield" class="form_bal_text1" ondrag="maintainDrag()"> <i class="fa fa-arrows-alt" style="float:right"></i> <div id="txtlb' + document.getElementById('<%=hfText.ClientID%>').value + '"> Label </div> <input id="txtDrag" type="text" size="45" runat="server" /> <a href="#" id="btnedit' + document.getElementById('<%=hfText.ClientID%>').value + '" class="button" onclick="btnclick(this.id)" > Edit </a>  </div> '
		}
		...
		function getradiobutton(event) {
			...
			return '<div id="li_rb" class="form_bal_radio1" style="width:300px" ondrag="maintainDrag()"> <i class="fa fa-arrows-alt" style="float:right"></i> <div id="rblb' + document.getElementById('<%=hfRadio.ClientID%>').value + '"> Label </div> <div id="divRadio' + document.getElementById('<%=hfRadio.ClientID%>').value + '">  </div> <a href="#" id="addrb' + document.getElementById('<%=hfRadio.ClientID%>').value + '" class="button" onclick="btnclick(this.id)"> Add </a> <a href="#" id="removeRB' + document.getElementById('<%=hfRadio.ClientID%>').value + '" onclick="removeRB(this.id)"> Remove selected option </a>  </div> '
		}

		function gettextArea(event) {

			return '<div id="li_textarea" class="form_bal_textarea1" ondrag="maintainDrag()"> <i class="fa fa-arrows-alt" style="float:right"></i> <div id="txtarealb' + document.getElementById('<%=hfTextarea.ClientID%>').value + '"> Label </div> <textarea rows="5" id="txtareaDrag' + document.getElementById('<%=hfTextarea.ClientID%>').value + '" placeholder=" "/> <a href="#" id="btntxtarea' + document.getElementById('<%=hfTextarea.ClientID%>').value + '" class="button" onclick="btnclick(this.id)" > Edit </a>  </div>'
		}

		function getCheckbox(event) {

			return '<div id="li_checkbox" class="form_bal_checkbox1" style="width:300px" ondrag="maintainDrag()"> <i class="fa fa-arrows-alt" style="float:right"></i> <div id="checklb' + document.getElementById('<%=hfCheck.ClientID%>').value + '"> Label </div> <div id="divCheck' + document.getElementById('<%=hfCheck.ClientID%>').value + '"> </div> <a href="#" id="addcheck' + document.getElementById('<%=hfCheck.ClientID%>').value + '" class="button" onclick="btnclick(this.id)" > Add </a> <a href="#" id="removeCheck' + document.getElementById('<%=hfCheck.ClientID%>').value + '" onclick="removeCheck(this.id)"> Remove selected option </a>  </div>'
		}

		function getHeader(event) {

			return ' <div id="li_header" class="form_bal_header1" ondrag="maintainDrag()"> <i class="fa fa-arrows-alt" style="float:right"></i>  <div id="headerlb' + document.getElementById('<%=hfHeader.ClientID%>').value + '" style="font-family:Arial; font-size:32px; font-weight:bold  "> Header </div> <a href="#" id="btneditheader' + document.getElementById('<%=hfHeader.ClientID%>').value + '" class="button" onclick="btnclick(this.id)"> edit </a> </div>'
		}

		function getParagraph(event) {

			return ' <div id="li_paragraph" class="form_bal_paragraph1" ondrag="maintainDrag()" style="max-width:450px;" > <i class="fa fa-arrows-alt" style="float:right"></i> <br /><p id="para_id' + document.getElementById('<%=hfParagraph.ClientID%>').value + '" > write something here </p> <a href="#" id="btneditpara' + document.getElementById('<%=hfParagraph.ClientID%>').value + '" class="button" onclick="btnclick(this.id)" > edit </a> </div>'
		}
		function getBigNumber(event) {

			return ' <div id="li_number' + document.getElementById('<%=hfNumber.ClientID%>').value + '" class="form_bal_number1" ondrag="maintainDrag()" > <i class="fa fa-arrows-alt" style="float:right"></i> Quantity <input type="number" id="bigNumQty' + document.getElementById('<%=hfNumber.ClientID%>').value + '" name="quantity" min="1" max="5"> <a href="#" id="btneditnumber' + document.getElementById('<%=hfNumber.ClientID%>').value + '" class="button" onclick="btnclick(this.id)"> edit </a>  </div>'
		}

		function getDate(event) {

			return ' <div id="li_date' + document.getElementById('<%=hfDate.ClientID%>').value + '" class="form_bal_date1" ondrag="maintainDrag()" > <i class="fa fa-arrows-alt" style="float:right"></i> Date <input type="date" id="date_id' + document.getElementById('<%=hfDate.ClientID%>').value + '" >   </div>'
		}

		function getUploadFile(event) {

			return ' <div id="li_file' + document.getElementById('<%=hfFile.ClientID%>').value + '" class="form_bal_file1" ondrag="maintainDrag()" > <i class="fa fa-arrows-alt" style="float:right"></i> <input type="file" id="myFile' + document.getElementById('<%=hfFile.ClientID%>').value + '" multiple size="50" onchange=""> </div>'
		}

		function getLabel(event) {

			return ' <div id="li_label' + document.getElementById('<%=hfLabel.ClientID%>').value + '" class="form_bal_label1" ondrag="maintainDrag()" > <i class="fa fa-arrows-alt" style="float:right"></i> <div id="labelID' + document.getElementById('<%=hfLabel.ClientID%>').value + '" style="font-size:16px; "> Label </div> <a href="#" id="btneditlabel' + document.getElementById('<%=hfLabel.ClientID%>').value + '" class="button" onclick="btnclick(this.id)"> edit </a>  </div>'
		}
		...
		<div>
			...
			<div class="form_builder" style="margin-top: 25px">
				<div class="row">
					...
					<div>
						...
						<asp:HiddenField ID="hfRadioChild" runat="server" />
						...
						<asp:HiddenField ID="hfCheckChild" runat="server" />
			...
			<div class="bg-modal-number">
				...
				<div class="modal-content">
					...
					Min quantity 
					<input type="number" id="changeMinNumber" />
					<br />
					Max quantity 
					<input type="number" id="changeMaxNumber" />
